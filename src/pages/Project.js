    ...
    <div className="Project">
      ...
      <Collapsible1 label="Final Year Project">
        <p>
          ...
          computational power (Raspberry Pi) to capture and determine if a parking slot is empty or occupied.<br />
          ...
          the backend, which can then be used to inform drivers of available parking spaces. The project is currently in the development stage.<br />
